...
phpBB %1$s je uspješno instaliran. Molimo da nastaviš odabirom jedne od ponuđenih opcija:</p>
...
<p><strong>Opaska:</strong> ukoliko instaliraš koristeći SQLite, moraš unijeti cijelu putanju do datoteke baze podataka u DSN polju te polja korisničkog imena i zaporke baze podataka ostaviti praznima. Iz sigurnosnih razloga, moraš se uvjeriti da datoteka baze podataka nije pohranjena na lokaciji dostupnoj s Weba.</p>

<p>phpBB3 podržava sljedeće baze podataka:</p>
<ul>
<li>MySQL 3.23 ili noviju verziju (MySQLi podržana);</li>
<li>PostgreSQL 7.3+;</li>
<li>SQLite 2.8.2+;</li>
<li>Firebird 2.1+;</li>
<li>MS SQL Server 2000 ili noviju verziju (direktno ili putem ODBC);</li>
<li>MS SQL Server 2005 ili novije (izvorno)</li>
<li>Oracle.</li>
</ul>

<p>Samo (te), na serveru podržane, baze će biti prikazane.',
...
'INST_ERR_DB_INVALID_PREFIX'=> 'Unešen prefiks nije valjan. Prefiks mora početi slovom i mora sadržavati samo slova, brojeve i podcrte.',
