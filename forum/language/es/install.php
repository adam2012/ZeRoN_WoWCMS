...
/** 
*
* install.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'El Conversor Unificado de phpBB requiere una instalación por defecto de phpBB3 para funcionar, por favor <a href="%s"> procedé a instalar phpBB3 por primera vez</a>.',
	...
	'CONV_ERROR_ATTACH_FTP_DIR'	=> 'El FTP para subir adjuntos está habilitado en el viejo Sitio. Por favor, deshabilitá esta opción de FTP y asegurate de especificar una capeta válida para subir, luego copiá todos los adjuntos a esta nueva carpeta. Una vez hecho esto, reinicia el conversor',
	...
	'CONV_OPTIONS_BODY'			=> 'Esta página recopila los datos requeridos para acceder al foro antiguo. Introducí los detalles de la base de datos de tu foro; el conversor no cambiará nada en esa base de datos. Debés deshabilitar el foro antiguo para una conversión correcta.',
	'CONV_SAVED_MESSAGES'	=> 'Mensajes guardados',

	'COULD_NOT_COPY'	=> 'No se puede copiar archivo <strong>%1$s</strong> a <strong>%2$s</strong><br /><br />Por favor verificá que la carpeta de destino existe y que el webserver pueda escribir ahí.',
	'COULD_NOT_FIND_PATH'	=> 'No se puede encontrar la ruta a tu antiguo Sitio. Por favor verificá tus parámetros e intentá de nuevo.<br />» La ruta especificada fue %s.',
	...
	'DB_HOST_EXPLAIN'	=> 'DSN significa Data Source Name y es relevante solo para instalaciones ODBC. En PostgreSQL, usa localhost para conectar con el servidor local a través del dominio del socket UNIX y 127.0.0.1 para conectar via TCP. En SQLite, introduci la ruta completa a tu base de datos.',
	'DB_NAME'	=> 'Nombre de base de datos',
	'DB_PASSWORD'	=> 'Clave de base de datos',
	'DB_PORT'	=> 'Puerto en el servidor de la base de datos',
	'DB_PORT_EXPLAIN'	=> 'Dejalo en blanco a menos que quieras que el servidor opere en un puerto distinto al estándar.',
	'DB_UPDATE_NOT_SUPPORTED'	=> 'Lo sentimos pero este script no soporta la actualización desde versiones de phpBB anteriores a la “%1$s”. La version que tenés instalada es la “%2$s”. Por favor actualizá a una versión previa antes de ejecutar este script. Si necesitás asistancia con esto acuda al Support Forum en phpBB.com (en inglés) o al foro de Soporte de phpBB3 en los foros de ayuda en español phpbb-es.com',
	'DB_USERNAME'	=> 'Usuario de base de datos',
	'DB_TEST'	=> 'Probar conexión',
	'DEFAULT_LANG'	=> 'Idioma por defecto del Sitio',
	'DEFAULT_PREFIX_IS'	=> 'El conversor no fue capaz de encontrar tablas con el prefijo especificado. Por favor asegurate de haber insertado los detalles correctos para el Sitio que estás convirtiendo. El prefijo de tabla por defecto para %1$s es <strong>%2$s</strong>.',
	'DEV_NO_TEST_FILE'	=> 'No ha sido especificado un valor para la variable test_file en el conversor. Si es un usuario de este conversor, no deberías estar viendo este error, Por favor reportá este mensaje al autor del conversor. Si sos vos, tenés que especificar el nombre de un archivo que exista en el Sitio original para permitir que sea verificada la ruta al mismo.',
	...
	'DL_CONFIG_EXPLAIN'	=> 'Podés descargar el config.php en tu propia PC. Luego podés subir el archivo manualmente, reemplazando cualquiera existente en el directorio raiz de phpBB 3.0. Por favor recordá subir el archivo en formato ASCII (fijate en la documentación de tu programa FTP si no estás seguro). Cuando hayas subido config.php por favor hace clic en “Done” (Hecho) para proceder al siguiente paso.',
	...
	'FILES_REQUIRED_EXPLAIN'	=> '<strong>Obligatorio</strong> - Para funcionar correctamente phpBB3 necesita ser capaz de acceder o escribir ciertos archivos o carpetas. Si vez “No encontró” tneés que crear dicho archivo o dicha carpeta. Si vez “No escribe” necesitás cambiar los permisos en los archivos o carpetas para permitir a phpBB3 escribir ahí.',
	'FILLING_TABLE'	=> 'LLenando tabla <strong>%s</strong>',
	'FILLING_TABLES'	=> 'LLenando tablas',
	'FIREBIRD_DBMS_UPDATE_REQUIRED'		=> 'phpBB no suporta más Firebird/Interbase anteriores a la Versión 2.1. Por favor actualizá tu instalación Firebird al menos a la versión 2.1.0 antes de proceder con la actualización.',
	'FINAL_STEP'	=> 'Procesando el paso final',
	'FORUM_ADDRESS'	=> 'Dirección del Sitio',
	'FORUM_ADDRESS_EXPLAIN'	=> 'Esta es la URL de tu antiguo Sitio, por ejemplo <samp>http://www.example.com/phpBB2/</samp>. Si se inserta una dirección acá y no lo dejás vacío cada instancia de esta dirección será reemplazanda por la nueva en mensajes, mensajes privados y firmas.',
	...
	'INITIAL_CONFIG_EXPLAIN'	=> 'Ahora que la instalación ha determinado que tu servidor puede ejecutar phpBB3 necesitás suministrar cierta información específica. Si no sabés cómo conectar a tu base de datos por favor contactá con tu proveedor de hospedaje (en primera instancia) o visitá el foro de soporte de phpBB3. Cuando ingreses los datos por favor asegurate de haberlos verificado concienzudamente.',
	'INSTALL_CONGRATS'	=> '¡Felicidades!',
	'INSTALL_CONGRATS_EXPLAIN'	=> '		
		Instalaste correctamente phpBB3 %1$s. Por favor procedé a elegir una de las siguientes dos opciones:</p>
		...
		<p>Haciendo clic en el botón de abajo llegarás a un formulario para enviar información estadística a phpBB en tu Panel de Control de Administración (ACP). Te estaríamos muy agradecidos si pudieras ayudarnos enviándonos esa información. Después podrías tomarte algún tiempo para examinar las opciones disponibles para vos. Recuerdá que hay disponible ayuda en línea mediante <a href="http://www.phpbb.com/support/documentation/3.0/">Documentación</a> y <a href="http://www.phpbb.com/community/viewforum.php?f=46">foros de soporte</a> (ambos en inglés), leé el documento <a href="%3$s">LEAME</a> para más información.</p><p><strong>Por favor borrá, muevé o renombrá la carpeta install antes de usar tu Sitio. Si esta carpeta se encuentra presente, solamente el Panel de Administración (ACP) será accesible.</strong>',
	'INSTALL_INTRO'	=> 'Bienvenido a la Instalación',
// TODO: write some more introductions here
'INSTALL_INTRO_BODY'	=> 'Con esta opción, es posible instalar phpBB en tu servidor.</p><p>Para proceder, necesitás los datos de configuración de tu base de datos (URL del servidor de la base de datos, nombre de la BDD., usuario de la BDD. y contraseña del usuario de la BDD.). Si no disponés de esta información por favor contactá con tu proveedor de hospedaje y preguntales. No podrás continuar sin esos datos. Necesitás:</p>
	...
	<p><strong>Nota:</strong> Si instalás usando SQLite, deberías ingresar la ruta completa al archivo de tu base de datos en el campo DSN y dejar los campos usuario y clave en blanco. Por razones de seguridad, deberías asegurarte de que el archivo de la base de datos no está alojado en una carpeta accesible desde la web.</p>
	...
	'INSTALL_INTRO_NEXT'	=> 'Para comenzar la instalación, por favor pulsá el botón de abajo.',
	...
	'INSTALL_NEXT_PASS'	=> 'Todas las pruebas básicas fueron aprobadas y podés proceder al siguiente paso de instalación. Si cambiaste permisos, módulos, etc. y querés repetir las pruebas podés hacerlo ahora.',
	...
	'INST_ERR_DB_FORUM_PATH'	=> 'La base de datos especificada está dentro del árbol de carpetas de tu Sitio. Deberás poner este archivo en un lugar no accessible desde la web.',
	...
	'INST_ERR_DB_NO_MYSQLI'	=> 'La versión de MySQL instalada en esta máquina es incompatible con la opción “MySQL con extensiones MySQLi” que seleccionaste. Por favor pruebá la opción “MySQL” en su lugar.',
	...
	'INST_ERR_DB_NO_ORACLE'	=> 'La versión de Oracle instalada en esta máquina requiere que configurés el parámetro <var>NLS_CHARACTERSET</var> a <var>UTF8</var>. O bien actualizá tu instalación a 9.2+ o cambiá el parámetro.',
	'INST_ERR_DB_NO_FIREBIRD'	=> 'La versión de Firebird instalada en esta máquina es más antigua que 2.1, por favor actualizá a una version más nueva.',
	...
	'INST_ERR_DB_NO_POSTGRES'	=> 'La base de datos que seleccionaste no fue creada en <var>UNICODE</var> o <var>UTF8</var>. Probá a reinstalar con una base de datos <var>UNICODE</var> o <var>UTF8</var>.',
	...
	'INST_ERR_PREFIX_INVALID'	=> 'El prefijo de tabla que especificaste es inválido para la base de datos que seleccionaste. Por favor probá con otro, eliminando caracteres como por ejemplo guión (-).',
...
// mbstring
	...
	'MAKE_FOLDER_WRITABLE'	=> 'Por favor asegurate de que esta carpeta existe y que el servidor web puede escribirla luego probá otra vez:<br />»<strong>%s</strong>.',
	'MAKE_FOLDERS_WRITABLE'	=> 'Por favor asegurate de que estas carpetas existen y que el servidor web puede escribir en ellas; luego probá otra vez:<br />»<strong>%s</strong>.',
    'MYSQL_SCHEMA_UPDATE_REQUIRED'   => 'El schema de su base de datos MySQL para phpBB quedó obsoleto. phpBB detectó un schema para MySQL 3.x/4.x, pero el servidor funciona con MySQL %2$s.<br /><strong>Antes de que procedas a la actualización necesitás actualizar el schema.</strong><br /><br />Por favor consultá este artículo (en inglés) <a href="http://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge Base article about upgrading the MySQL schema</a>. Si encontrás problemas o no se defendés con el inglés, por favor acudí al <a href="http://www.phpbb-es.com/foro/">foro de soporte en español</a>.',
...
// TODO: Write some explanatory introduction text
	...
	'PHP_SUPPORTED_DB_EXPLAIN'	=> '<strong>Obligatorio</strong> - Necesitá soporte para al menos una base de datos compatible con PHP. Si no se muestran módulos disponibles deberías contactar a tu proveedor de hosting o revisar la documentacion de PHP pertinente.',
	...
	'PRE_CONVERT_COMPLETE'	=> 'Todos los pasos preconversión se han completado con éxito. Ahora podés comenzar el proceso de conversión. Por favor notá que podrías tener que ajustar varios detalles manualmente. Después de la conversión, verificá especialmente los permisos asignados, reconstruye tu índice de búsqueda si es necesario y también asegurate de que los archivos se copien correctamente, por ejemplo avatares y emoticonos.',
	...
	'RETRY_WRITE_EXPLAIN'	=> 'Si lo deseas podés cambiar los permisos de config.php para permitir a phpBB3 sobreescribirlo. Si quisieras hacer esto deberías hacer clic en Retry (Reintentar) para intentarlo de nuevo. Recuerdá restaurar los permisos de config.php después de que phpBB3 haya finalizado la instalación.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Tu viejo índice de búsqueda no fue convertido. Las búsquedas arrojarán un resultado vacío. Para crear nuevos índices de búsqueda vaya al Panel de Administración (ACP), seleccioná Mantenimiento y luego Indice de búsqueda en el submenú.',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Los parámetros en esta página son solamente necesarios si sabes qué querés algo diferente que no sea por defecto. Si no estás seguro, simplemente pasá a la siguiente página, ya que esos parámetros pueden ser cambiados desde el Panel de Administración (ACP).',
	'STAGE_CONFIG_FILE'	=> 'Archivo de configuración',
	'STAGE_CREATE_TABLE'	=> 'Crear tablas en la base de datos',
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'Las tablas en la base de datos usadas por phpBB 3.0 han sido creadas y llenadas con algunos datos. Procedé a la siguiente pantalla para terminar de instalar phpBB3.',
...
// TODO: Write some text on obtaining support
	...
	'UPDATE_TOPICS_POSTED_ERR'	=> 'Ha ocurrido un error mientras generabas información de topics posteados. Podés reintentar este paso en el Panel de Administración (ACP) después de completar el proceso de conversión.',
...
$lang = array_merge($lang, array(
	...
	'COLLECTED_INFORMATION_EXPLAIN'	=> 'La lista de abajo muestra información sobre los archivos que necesitan ser actualizados. Por favor leé la información frente a cada bloque de estado para entender qué significan y qué puede ser necesario hacer para efectuar una actualización con éxito.',
	...
	'DATABASE_UPDATE_INFO_OLD'	=> 'La actualización de la base de datos en la carpeta de instalación está desactualizada. Por favor asegurate de haber subido la versión correcta del archivo.',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Una vez descargado, deberías desempaquetar el archivo. Encontrarás dentro los archivos modificados que necesitás subir al directorio raíz de tu foro phpBB. Por favor, subílos a sus respectivas ubicaciones. Después de que los hayas subido todos, por favor verificá los archivos de nuevo con el otro botón de abajo.',
	...
	'FILES_CONFLICT_EXPLAIN'	=> 'Los siguientes archivos han sido modificados y no coinciden con los archivos originales de la antigua versión. phpBB ha determinado que esos archivos creará conflitos si se intenta insertarlos. Por favor investigá los conflictos y tratá de resolverlos manualmente o continuá la instalación decidiendo el método de integración preferido. Si resolvés los conflictos manualmente verificá los archivos nuevamente después de modificarlos. También podés decidir un método de integración para cada archivo. El primero dará como resultado un archivo donde las líneas conflictivas de tu viejo archivo se perderán, el otro dará como resultado perder los cambios en el nuevo archivo.',
	...
	'MAPPING_FILE_STRUCTURE'	=> 'Para facilitar la subida cá están las ubicaciones de los archivos que mapean la instalación de phpBB.',
	...
	'MERGING_FILES_EXPLAIN'		=> 'Se están reuniendo los cambios en el archivo final.<br /><br />Por favor, esperá hasta que phpBB haya completado todas las operaciones en los archivos cambiados.',
	...
	'NO_UPDATE_FILES_OUTDATED'	=> 'No se encontró una carpeta válida de actualización, por favor asegurate de que subiste todos los archivos.<br /><br />Tu instalación <strong>no</strong> parece estar actualizada. Hay actualizaciones diponibles para su versión de phpBB %1$s, por favor visitá <a href="http://www.phpbb.com/downloads/" rel="external">http://www.phpbb.com/downloads/</a> para obtener el paquete adecuado para actualizar de la Versión %2$s a la Versión %3$s.',
	'NO_UPDATE_FILES_UP_TO_DATE'	=> 'Tu versión está actualizada. No hay necesidad de ejecutar la herramienta de actualización. Si querés verificar la integridad de sus archivos asegurate de haber subido los archivos actualizados correctos.',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'Las diferencias actuales entre los archivos %1$d y %2$d han sido comprobadas.<br />Por favor esperá hasta que todos los ficheros sean chequeados.',
	...
	'PERFORM_DATABASE_UPDATE_EXPLAIN'	=> 'Debajo podés encontrar un enlace al script de actualización de la base de datos. Este script necesita ejecutarse separadamente porque actualizar la base de datos si está identificado puede acarrear comportamientos inesperados. La actualización de la base de datos puede tardar un rato, por favor no detengas la ejecución aunque parezca estar detenida. Después de realizar la actualización siga el enlace para continuar el proceso de actualización.',
	...
	'SQL'	=> 'SQL',
	'SQL_FAILURE_EXPLAIN'	=> 'Esto probablemente no sea nada de qué preocuparse, la actualización continuará. Si no se puede completar tendrías que visitar nuestros foros de ayuda. Visitá <a href="../docs/README.html">LEAME</a> para detalles de como obtener ayuda.',
	...
	'TRY_DOWNLOAD_METHOD'		=> 'Podés querer intentar el método de descarga de ficheros modificados.<br />Este método siempre funciona y además es el camino de actualización recomendado.',
	...
	'UPDATE_FILES_NOTICE'	=> 'Por favor asegurate de que ha actualizado también los archivos de tu Sitio, este archivo está solamente actualizando tu base de datos',
	...
	'UPDATE_INSTRUCTIONS'	=> '		
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Visitá la <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">página de descargas de phpBB.com</a> y descargue el archivo "Paquete de Actualización phpBB" correspondiente.<br /><br /></li>
	...
	'UPDATE_INSTRUCTIONS_INCOMPLETE'	=> '
		...
		<p>phpBB detectó una actualización automática incompleta. Por favor, asegúrate de que siguió cada paso de la herramienta de actualización automática. Abajo encontrarás el enlace para actualizar de nuevo, o andá directamente a la carpeta install.</p>
	',
	'UPDATE_METHOD'	=> 'Método de actualización',
	'UPDATE_METHOD_EXPLAIN'	=> 'Ahora podés elegir su método de actualización. Usar la subida por FTP te presentará un formulario donde tendrás que insertar los datos de tu cuenta FTP. Con este método los archivos serán movidos a tu nueva ubicación y se creará una copia de seguridad de los archivos viejos agregando .bak al nombre del archivo. Si elegís descargar los archivos modificados tenés que desempaquetarlos y subirlos posteriormente a su ubicación correcta manualmente.',
	...
	'UPGRADE_INSTRUCTIONS'         => 'Una nueva actualización <strong>%1$s</strong> está disponible. Por favor leé <a href="%2$s" title="%2$s"><strong>el anuncio de la actualización</strong></a> para saber sobre lo que ofrece y cómo actualizar.',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Verificá si tu instalación de phpBB está actualizada.',
