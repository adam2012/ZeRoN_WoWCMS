...
/** 
*
* acp_permissions.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Se usan para crear diferentes paquetes de varios tipos de permisos posteriormente asignables a los distintos Roles. Los roles por defecto deberían cubrir la administración del Sitio en sus cuatro divisiones, podés agregar/editar/borrar roles como crea conveniente.</p>
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Acá podés asignar derechos de administrador para usuarios o grupos. Todos los usuarios con permisos administrativos pueden ver el Panel de Administración (ACP).',
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'Acá podés asignar usuarios y grupos como moderadores de foros. Para asignar accesos de usuario a los foros, para definir derechos de moderador global o administrativos por favor usá la sección correspondiente.',
	'ACP_FORUM_PERMISSIONS_COPY_EXPLAIN'		=> 'Acá podés copiar permisos de foro de un foro a otro foro o a otros foros.',
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'Acá podés modificar cuales usuarios y grupos pueden acceder a qué foro. Para asignar moderadores o definir administradores por favor usá la sección correspondiente.',
	...
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Acá podés administrar los roles para permisos administrativos. Los roles actúan como permisos, si cambias un rol los elementos asignados al mismo también cambiarán sus permisos.',
	...
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Acá podés administrar los roles para permisos de moderadores. Los roles actúan como permisos, si cambias un rol los elementos asignados al mismo también cambiarán sus permisos.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Acá podés administrar los roles para permisos de usuario. Los roles actúan como permisos, si cambias un rol los elementos asignados al mismo también cambiarán sus permisos.',
