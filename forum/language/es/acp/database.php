...
/** 
*
* acp_database.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ACP_RESTORE_EXPLAIN'	=> 'Esto efectuará una recuperación completa de todas las tablas de phpBB guardadas en el archivo. Si el servidor lo permite, podés usar un archivo comprimido con gzip o bzip2 y será descomprimido automáticamente. <strong>ADVERTENCIA</strong> Esto sobreescribirá cualquier dato existente. La recuperación puede llevar algún tiempo, por favor no lo muevas de esta página hasta que se complete.',
	...
	'DELETE_SELECTED_BACKUP'	=> '¿Estás seguro de que querés borrar la copia de seguridad seleccionada?',
