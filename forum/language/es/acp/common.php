...
/** 
*
* acp_common.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'LOGIN_ADMIN_CONFIRM'		=> 'Para administrar el Sitio debés introducir tu contraseña otra vez.',
	...
	'NO_PASSWORD_SUPPLIED'		=> 'Necesitás introducir tu contraseña para acceder al Panel de Administración (ACP).',	
   ...
   'SETTING_TOO_SHORT'      => 'El valor introducido para el parámetro “%1$s” no es suficientemente largo. La longitud mínima permitida es %2$d.',
	...
	'USERNAMES_EXPLAIN'		=> 'Insertá cada nombre de usuario en una línea diferente',
...
// Logs
$lang = array_merge($lang, array(
	'ACP_ADMIN_LOGS_EXPLAIN'	=> 'Listado de las acciones realizadas por administradores. Podés ordenarlas por nombre de usuario, fecha, IP o acción. Si tenés los permisos apropiados podés borrar acciones individuales o incluso el registro completo.',
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'Listado de las acciones realizadas por el Sitio en sí mismo. Este log le proporciona información que te puede ser útil para resolver problemas específicos, por ejemplo emails no enviados. Podrás ordenarlas por nombre de usuario, fecha, IP o acción. Si tenés los permisos apropiados podés borrar acciones individuales o incluso el registro completo.',
	'ACP_MOD_LOGS_EXPLAIN'	=> 'Listado de las acciones realizadas por moderadores, elejí un foro del combo desplegable. Podés ordenarlas por nombre de usuario, fecha, IP o acción. Si tenés los permisos apropiados podés borrar acciones individuales o incluso el registro completo.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'Visión general de las últimas cinco acciones llevadas a cabo por los administradores del Sitio. Podés ver el registro completo en el menú correspondiente o siguiendo el enlace de abajo.',
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD_EXPLAIN'			=> '<var>mbstring.func_overload</var> se debe establecer en 0 o 4. Podés comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> se debe establecer en <samp>pass</samp>. Podés comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
	...
	'PURGE_CACHE_CONFIRM'	=> '¿Estás seguro de que querés limpiar la caché?',
	...
	'RESET_DATE_CONFIRM'			=> '¿Estás seguro de que querés reiniciar la fecha de comienzo del Sitio?',
	...
	'RESYNC_POST_MARKING_CONFIRM'	=> '¿Estás seguro de que querés resincronizar los temas marcados?',
	'RESYNC_POST_MARKING_EXPLAIN'	=> 'Primero desmarcá todos los temas y luego marcá correctamente los temas que han tenido actividad en los últimos seis meses.',
	'RESYNC_STATS'					=> 'Sincronizar estadísticas',
	'RESYNC_STATS_CONFIRM'			=> '¿Estás seguro de que querés resincronizar las estadísticas?',
	'RESYNC_STATS_EXPLAIN'			=> 'Recalculá el número total de mensajes, temas, usuarios y archivos.',
	'RUN'							=> 'Ejecutar',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN'		=> 'Ésta es una lista de usuarios registrados, pero con cuentas inactivas. Podés activar, borrar o recordárselo (enviando un e-mail) si querés.',
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Ésta es una lista de los últimos 10 usuarios registrados que tienen cuentas inactivas. Una lista completa está disponible desde el menú o siguiendo el enlace donde podés activar, borrar o recordárselo (enviando un e-mail) si querés.',
...
$lang = array_merge($lang, array(
	...
	'DONT_SEND_STATISTICS'		=> 'Volvé al ACP si no deseás enviar información estadística a phpBB.',
