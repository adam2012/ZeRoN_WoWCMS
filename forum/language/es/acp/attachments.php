...
/** 
*
* acp_attachments.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'Acá podés configurar los principales parámetros para archivos adjuntos y las categorías especiales asociadas.',
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Acá podés añadir, borrar, modificar o deshabilitar los grupos de extensiones. Opciones adicionales incluyen su asignación a una categría especial, cambiar el mecanismo de descarga y definir un icono que se mostrará delante del adjunto que pertenezca al grupo.',
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'		=> 'Acá podés editar sus extensiones permitidas. Para activar sus extensiones, por favor dirijite al Panel de Administración (ACP) de extensiones de grupo. te recomendamos encarecidamente no permitir extensiones de scripts (como <code>php</code>, <code>php3</code>, <code>php4</code>, <code>phtml</code>, <code>pl</code>, <code>cgi</code>, <code>py</code>, <code>rb</code>, <code>asp</code>, <code>aspx</code>, y similares).',
	...
	'DOWNLOAD_REMOVE_IPS_EXPLAIN'		=> 'Podés eliminar (o des-excluir) múltiples direcciones IP al mismo tiempo usando la combinación apropiada de ratón y teclado para tu navegador (p.ej. Ctrl+Clic). Las IPs <em>excluidas</em> están en negrita.',
	...
	'EXCLUDE_ENTERED_IP'				=> 'Habilitálo para excluir la IP/hostname ingresada.',
