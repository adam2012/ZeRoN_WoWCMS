...
/** 
*
* acp_search.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	'ACP_SEARCH_INDEX_EXPLAIN'		=> 'Acá podés gestionar los índices de búsqueda. Ya que normalmente usa solo un índice deberías borrar los restantes. Después de modificar alguno de los parámetros del motor de búsqueda (p.ej. el número de caracteres min/máximos) sería importante actualizar el índice para que refleje estos cambios.',
	'ACP_SEARCH_SETTINGS_EXPLAIN'	=> 'Acá podés definir qué índice de búsqueda se usará para indexar mensajes y efectuar búsquedas. Podés ajustar varias opciones que pueden influir en cuánto procesamiento requieran dichas acciones. Algunos de estos ajustes son los mismos para todos los motores de búsqueda.',
	...
	'CONFIRM_SEARCH_BACKEND'			=> '¿Estás seguro de que querés cambiar a un motor de búsqueda diferente? Después de cambiar debés crear un nuevo índice. Si no planeas volver al anterior, también podés borrar tu índice para liberar recursos de sistema.',
	...
	'SWITCHED_SEARCH_BACKEND'		=> 'Cambiaste de motor de búsqueda. Para emplear el nuevo motor asegurate de que haya un índice para el motor que eligiste.',
	...
	'YES_SEARCH_EXPLAIN'		=> 'Habilitá al usuario facilidades de búsqueda, incluyendo búsqueda de usuarios.',
