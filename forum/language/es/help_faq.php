...
/** 
*
* help_faq.php [Argentinian Spanish (Formal Honorifics)‎]
*
* @package language
* @version $Id: $
* @package language
...
$help = array(
	...
	array(
		...
		1	=> 'Existen varias razones por lo cuál esto puede suceder. Primero, asegurate de que tu nombre de usuario y contraseña se encuentren escritos correctamente. Si lo están, comunicate con La Administración para asegurarte de que no has sido excluído. También es posible que el foro esté mal configurado por su dueño y/o tenga fallos en la programación, por lo que necesitaría ser reparado.',
	),
	array(
	...
	array(
		...
		1	=> 'Si no activas la casilla <em>Entrar automáticamente</em> cuando ingresas al foro, tus datos se guardan en una cookie segura, que se elimina al salir de la página o en cierto tiempo. Esto previene que tu cuenta pueda ser usada por otra persona. Para que el sistema le reconozca automáticamente solo marcá la casilla al ingresar. No es recomendable si accedés al foro desde una PC compartido, e.j. biblioteca, cyber-cafés, PC\'s de universidades, etc. Si no ves la casilla, significa que la administración del foro ha deshabilitado la opción.',
	),
	array(
		0	=> '¿Cómo evito que mi nombre de usuario aparezca en las listas de usuarios identificados?',
		1	=> 'Dentro del Panel de Control de Usuario, en "Preferencias de Foros", encontrarás la opción <em>Ocultar mi estado de conexión</em>. Habilitá la opción con <em>SI</em> y solamente serás visto por administradores, moderadores y usted mismo. Serás contado como un usuario oculto.',
	),
	array(
		0	=> '¡Perdí mi contraseña!',
		1	=> 'No te asustes, ¡calma! Si tu contraseña no puede ser recuperada podés desactivarla o cambiarla. Visitá la página de ingreso (login) y hacé clic en <em>Olvidé mi contraseña</em>. Seguí las instrucciones y estarás identificado nuevamente en muy poco tiempo.',
	),
	array(
		0	=> 'Me registré ¡y no me puedo identificar!',
		1	=> 'Primero, verificá tu nombre de usuario y contraseña. Si todo está correcto, hay dos posibles razones. Si el Sistema de Protección Infantil (COPPA) está activado y cuando te registraste elegiste la opción <em>Soy menor de 13 años</em> entonces tendrás que seguir algunas instrucciones que se te darán para activar la cuenta. Algunos foros disponen que las cuentas deben ser activadas, ya sea por vos mismo o por La Administración, antes de que puedas identificarte; esta información se te brindará al finalizar el proceso de registro. Si se te envió un e-mail, seguí las instrucciones. Si no recibiste ningún e-mail, seguramente la dirección de correo electrónico que proporcionaste no es correcta o tal vez haya sido capturada por un filtro de spam. Si estás seguro de que la dirección de e-mail que proporcinaste es correcta, enviá un mensaje a La Administración.',
	),
	array(
	...
	array(
		...
		1	=> 'Si sos un usuario registrado, todos tus datos y configuraciones están archivados en nuestra base de datos. Para modificarlos, visitá el Panel de Control de Usuario; el enlace se encuentra en la parte superior de las páginas del foro. Este sistema te permitirá cambiar tus datos y preferencias.',
	),
	array(
		0	=> '¡La hora en los foros no es correcta!',
		1	=> 'La hora no es correcta, es posible que estés viendo la hora correspondiente a otra zona horaria. Si este es el caso, visitá el Panel de Control de Usuario y definí tu zona horaria de acuerdo a tu ubicación, e.j. Londres, París, Nueva York, Sydney, etc. Recordá que para cambiar la zona horaria, como las demás preferencias, debés estar registrado. Si no lo estás, este es un buen momento para hacerlo.',
	),
	array(
	...
	array(
		...
		1	=> 'Esto se puede deber a que la administración no ha instalado el paquete de tu idioma para el foro o nadie ha creado una traducción. Preguntale al administrador si puede instalar el paquete del idioma que necesita. Si el paquete no existe, sentíte libre de hacer una traducción. Podés encontrar más información en el sitio de phpBB (ver el enlace al final de la página).',
	),
	array(
	...
	array(
		...
		1	=> 'Para publicar un nuevo tema en el foro registrate como miembro, haciendo clic en el enlace de registro, generalmente arriba de cada página. Seguramente necesitás registrarte antes de poder publicar y reponder. Abajo de cada foro encontrarás una lista de acciones permitidas. Ejemplo: Podés publicar nuevos temas, Podés votar en las encuestas, etc.',
	),
	array(
		0	=> '¿Cómo se puede editar o borrar un mensaje?',
		1	=> 'A menos que seas administrador o moderador, solo podés borrar o editar tus propios mensajes. Para editarlos debés hacer clic en en botón <em>editar</em>, a veces esta opción solo es válida durante un cierto periodo de tiempo. Si alguien editó tu tema, encontrarás un pequeño texto en el suyo diciendo que ha sido modificado y las veces que lo ha sido. No aparece si fue un moderador o la administración quién lo editó, aunque la mayoria de las veces dejan un mensaje aclaratorio. Los usuarios normales no podrán borrar sus temas después de que alguien haya respondido al mismo.',
	),
	array(
		0	=> '¿Cómo se puede añadir una firma a mi mensaje?',
		1	=> 'Para añadir una firma a tus mensajes debés crearla en el Panel de Control de Usuario. Una vez creada, activá la opción <em>Añadir firma</em> cuando publiques un mensaje. Podés asignar una firma por defecto a todos tus mensajes activando la casilla correcta en tu perfil. Para dejar de añadirla en los mensajes, debés desactivar la opción <em>Añadir firma</em> dentro del perfil.',
	),
	array(
		0	=> '¿Cómo creo una encuesta?',
		1	=> 'Cuando inicias un nuevo tema o editas el primer mensaje del mismo, debés hacer clic en la etiqueta "Agregar Encuesta" debajo del formulario de publicación; si no la visualizas, significa que no posees los permisos apropiados para crear encuestas. Insertá un título y al menos dos opciones en el campo apropiado, asegurandote de que cada opción se encuentre en la correspondiente línea del formulario. También podés elegir el número de opciones que el usuario puede seleccionar en la etiqueta "Opciones por usuario", el tiempo límite en días para la encuesta (0 para duración infinita) y por último la opción de permitir a lo usuarios cambiar su votos.',
	),
	array(
		0	=> '¿Por qué no se puede añadir más opciones a la encuesta?',
		1	=> 'El límite para opciones de una encuesta es fijado por la administración. Si sentís que necesitás añadir más opciones de las permitidas a la encuesta, comunicate con La Administración del foro.',
	),
	array(
		0	=> '¿Cómo edito o borro una encuesta?',
		1	=> 'Como en los mensajes, las encuestas solo pueden ser modifiacadas por su creador original, un moderador o la administración. Para editar una encuesta, hacé clic para editar el primer mensaje del tema; este siempre esta asociado a la encuesta. Si nadie ha votado, los usuarios pueden borrar la encuesta o editar las opciones. Sin embargo, si algún miembro ha votado, solo moderadores o administradordes pueden editar o borrar la encuesta. Esto evita que las encuestas sean cambiadas a mitad de la votación.',
	),
	array(
		0	=> '¿Por qué no se puede acceder a algún foro?',
		1	=> 'Algunos foros pueden estar limitados para ciertos usuarios o grupos y para visualizar, leer, publicar o llevar a cabo otra acción acá necesitás una autorización especial. Comunicate con un moderador o administrdor del foro para que se te conceda el acceso.',
	),
	array(
		0	=> '¿Por qué no se puede añadir archivos adjuntos?',
		1	=> 'Los permisos para adjuntar archivos son individuales para cada foro, grupo, usuario y son cedidos por la administración. Tal vez la administración no permite adjuntar archivos en el foro en que te encontrás ó solo ciertos grupos pueden hacerlo. Comunicate con La Administración si no estás seguro de por qué no podés adjuntar archivos.',
	),
	array(
		0	=> '¿Por qué recibí una advertencia?',
		1	=> 'Los administradores de cada foro tienen su propio conjunto de reglas para su sitio. Si has quebrantado alguna regla podés recibir una advertencia. Por favor recordá que esta es una decisión de la administración del foro, y el phpBB Group no tiene nada que ver con las advertencias dadas en este sitio. Comunicate con La Administración del foro si no estás seguro de porqué fuiste advertido.',
	),
	array(
	...
	array(
		...
		1	=> 'Los emoticones son pequeñas imágenes que pueden ser utilizadas para expresar un sentimiento con un pequeño código, e.j. :) denota felicidad, mientras que :( denota tristeza. La lista completa de emoticones puede verse en el formulario de publicación. Tratá de no abusar del uso de emoticones, pues pueden hacer que un mensaje se vuelva muy díficil de leer y un moderador remueva el tema o los emoticones del mensaje. La administración puede fijar un límite para el número de emoticones a utilizarse en un mensaje.',
	),
	array(
		0	=> '¿Puedo publicar imagenes?',
		1	=> 'Sí, las imagenes se pueden mostrar en tus mensajes. Si la administración permite adjuntar archivos, podés subir la imagen directamente al foro. De otra manera, debés guardar primero tu foto en un servidor de acceso público, e.j. http://www.ejemplo.com/mi-imagen.gif. No podés publicar imágenes que se encuentren en tu PC (a menos que sea un servidor de acceso público) ni tampoco las que se encuentren guardadas bajo mecánismos de autentificación, e.j. hotmail o yahoo correo, sitios protegidos por contraseñas, etc. Para exhibir imágenes utilizá el BBCode cuya etiqueta es [img].',
	),
	array(
	...
	array(
		...
		1	=> 'Podés ver todos los Grupos de usuarios a través del enlace "Grupos de Usuarios". Si deseas unirte a algún grupo, podés proceder haciendo clic en el botón apropiado. No todos los grupos tienen libre acceso. Sin embargo, algunos requieren aprobación para poder unirse, otros están cerrados y algunos son ocultos. Si el grupo se encuentra abierto, podés unirte haciendo clic en el botón correspondiente. Si el grupo requiere de aprobación para unirse, podés solicitar la membresía haciendo clic en el botón correspondiente. El responsable del grupo deberá aprobar tu solicitud y seguramente le preguntará por qué deseas hacerlo. Por favor no molestes continuamente al Responsable de Grupo si rechaza tu solicitud; seguramente tenga sus razones.',
	),
	array(
		0	=> '¿Cómo me convierto en Responsable del Grupo?',
		1	=> 'El Responsable de un grupo es asignado por la administración al crear el grupo. Si estás interesado en crear un grupo de usuarios, tu primer punto de contacto debe ser la administración; probá enviándole un mensaje privado.',
	),
	array(
	...
	array(
		...
		1	=> 'Hay tres razones posibles; no estás registrado y/o no identificado, la administración del foro ha desabilitado la opción de mensajes privados para todos los usuarios, ó la administración ha deshabilidato para vos la opción de enviar mensajes. Comunicate con La Administración para más información.',
	),
	array(
	...
	array(
		...
		1	=> 'Podés utilizar la lista para organizar otros usuarios del foro. Los usuarios añadidos a tu lista de Amigos podrán verse en en Panel de Control de Usuario para un rápido acceso a ver si están identificados y poder así enviarles un mensaje privado. Según la plantilla que utilice el foro, los mensajes de estos usuarios pueden visualizarse resaltados. Si añadís un usuario a tu lista de Ignorados, todos tus mensajes serán ocultados.',
	),
	array(
		0	=> '¿Cómo se puede añadir ó borrar usuarios de mi lista de Amigos e Ignorados?',
		1	=> 'Podés añadir usuarios a tu lista de dos maneras. En cada perfil de usuario hay un enlace para añadirlo a tu lista de Amigos y/o Ignorados. Otra alternativa es desde el Panel de Control de Usuario, añadiendo un usuario directamente ingresando su nombre. También podés eliminar usuarios de tu lista desde esta misma página.',
	),
	array(
		0	=> '--',
	...
	array(
		...
		1	=> 'Ingresando un término de búsqueda en el campo correspondiente del buscardor del index, foro ó en los temas. Podés acceder a búsquedas avanzadas haciendo clic en el enlace "Búsqueda Avanzada" que está disponible en todas las páginas del foro. La manera de acceder a la búsqueda depende del estilo utilizado.',
	),
	array(
	...
	array(
		...
		1	=> 'La búsqueda devolvió muchos resultados para ser procesados por el servidor. Utilizá "Búsqueda Avanzada" y sé más específico en los términos y foros a buscar.',
	),
	array(
		0	=> '¿Cómo busco usuarios?',
		1	=> 'Pulsá en el enlace "Usuarios" y hacé clic en el enlace "Buscar un usuario".',
	),
	array(
		0	=> '¿Como se puede encontrar mis propios mensajes y temas?',
		1	=> 'Podés econtrar tus mensajes haciendo clic en  "Mostrar tus mensajes" en el Panel de Control de Usuario o a través de tu propio perfil. Para buscar tus temas, utilizá la página de búsqueda avanzada y completá las opciones apropiadas.',
	),
	array(
		0	=> '--',
	...
	array(
		...
		1	=> 'Para suscribirte a un foro en especial, debés hacer clic en el enlace "Suscribir Foro". Para suscribirte a un tema, debés activar la casilla "Subscribir" cuando envíes una respuesta al mismo o hacer clic en el enlace "Subscribir tema".',
	),
	array(
		0	=> '¿Cómo borro mis suscripciones?',
		1	=> 'Para eliminar tus suscripciones, debés entrar en el Panel de Control de Usuario y hacer clic en la etiqueta "Organizar suscripciones".',
	),
	array(
		0	=> '--',
		1	=> 'Archivos Adjuntos',
	...
	array(
		...
		1	=> 'Para encontrar la lista de tus archivos adjuntos, debés entrar en el Panel de Control de Usuario y hacer clic en la etiqueta "Organizar adjuntos".',
	),
	array(
		0	=> '--',
		1	=> 'Acerca de phpBB3',
