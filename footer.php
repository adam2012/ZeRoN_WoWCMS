...
<li><a href="http://zeron-wow.dyndns.org/download/ZeRoN_WoW.exe"><?php echo $Client_down['Client_down']; ?></a></li>
</ul>
</div>
<div class="column">
<h3 class="account">
...
<center>
<br>
<small><?php echo $copyright3['']; ?><a href=" http://zeron-wow.dyndns.org/"><img src="http://zeron-wow.dyndns.org/download/wof-logo.png" alt="" align="absBottom"></a><br /><?php echo $copyright['copyright']; ?> - <?php echo date('Y'); ?> <?php echo $website['title']; ?>.<br /><?php echo $copyright4['copyright4']; ?></small>
</center>
</div>
